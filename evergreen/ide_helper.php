...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Determine if the application senderRoutes are cached.
         *
         * @return bool 
         * @static 
         */
        ...
        /**
         * Get the path to the senderRoutes cache file.
         *
         * @return string 
         * @static 
         */
    ...
    class Broadcast {
        ...
        /**
         * Register the senderRoutes for handling broadcast authentication and sockets.
         *
    ...
    class Route {
        ...
        /**
         * Set a global where pattern on all senderRoutes.
         *
         * @param string $key
         * @param string $pattern
         * @return void 
        ...
        /**
         * Set a group of global where patterns on all senderRoutes.
         *
        ...
        /**
         * Register the typical authentication senderRoutes for an application.
         *
         * @return void 
         * @static 
         */
